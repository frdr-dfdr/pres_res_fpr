...
## Formats 
[01_agrégat.csv](./csv_downloads/01_agrégat.csv) (CSV 4.6 Ko) 
...
|:------------------------------|:------------|:-----------------------------------------------|:-------------------------|:---------------------------|
| 7Zip format                   | .7z         | Conserver mais extraire le contenu             | Complet                  | 1                          |
...
| Tape Archive Format           | .tar        | Conserver mais extraire le contenu             | Complet                  | 2,454                      |
| XZ File Format                | .xz         | Conserver mais extraire le contenu             | Complet                  | 5                          |
| ZIP Format                    | .zip        | Conserver mais extraire le contenu             | Complet                  | 2,038                      |