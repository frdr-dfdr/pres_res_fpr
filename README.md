...
- Action de préservation proposée - comprend les actions entreprises pour préserver le format. Le fichier original est toujours conservé si une action de préservation est répertoriée. Si aucune action de préservation n'est associée au format, la mention « Original » est indiquée.
